...
public class PersistentPreferences extends org.eclipse.embedcdt.debug.gdbjtag.core.preferences.PersistentPreferences {
	...
	public String getGdbServerOtherOptions() {
		...
		return DefaultPreferences.SERVER_OTHER_OPTIONS_DEFAULT;
	}

	public String getGdbServerOtherOptionsForRISCV_32() {

		return DefaultPreferences.SERVER_OTHER_OPTIONS_DEFAULT_RISC_V_32;
	}
